...
#define TIME_TO_SLEEP 1000 * 60 * 1      // Time ESP32 will go to sleep (in seconds)
#define WAKEUP_INTERVAL 60*29     // Wakeup interval for advertising (in seconds)
...
void setup(){
  ...
  SerialBT.begin("AKU_M2"); //Bluetooth device name
